...
namespace CodeGenerator
{
    public static class Extensions
    {
        ...
        public static IEnumerable<T> FindAll<T>(this ParserRuleContext tree, bool searchInResults = false)
            where T : IParseTree
        {
        ...
        {
            if (enumerable.Any()) return enumerable.Aggregate((current, t) => current.Concat(t));
