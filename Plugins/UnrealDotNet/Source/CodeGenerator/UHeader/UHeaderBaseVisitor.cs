...
public partial class UHeaderBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IUHeaderVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="UHeaderParser.methodParametrMetadata"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitMethodParametrMetadata([NotNull] UHeaderParser.MethodParametrMetadataContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitMethodParametrTemplate([NotNull] UHeaderParser.MethodParametrTemplateContext context) { return VisitChildren(context); }
	/// <summary>
