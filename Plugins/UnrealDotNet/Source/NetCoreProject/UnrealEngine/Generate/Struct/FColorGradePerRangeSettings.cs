...
namespace UnrealEngine
{
	...
	/// </summary>
	public partial class FColorGradePerRangeSettings
	{
		...
		{
			NativePointer = E_CreateStruct_FColorGradePerRangeSettings();
			IsRef = false;
		}

		internal FColorGradePerRangeSettings(IntPtr NativePointer, bool IsRef)
		{
