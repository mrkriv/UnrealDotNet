...
FString UManageArrowComponent::GetProperty(const FString& Property)
{
	return bIsManageAttach ? UCoreShell::GetProperty(this, Property) : "";
}

void UManageArrowComponent::SetProperty(const FString& Property, const FString& Value)
{
...
void UManageArrowComponent::PostDuplicate(bool bDuplicateForPIE)
{
...
void UManageArrowComponent::SetAllPhysicsAngularVelocity(const FVector& NewAngVel, bool bAddToCurrent)
{
...
void UManageArrowComponent::AddToCluster(UObjectBaseUtility* ClusterRootOrObjectFromCluster, bool bAddAsMutableObject)
{
