...
FString UManageBillboardComponent::GetProperty(const FString& Property)
{
	return bIsManageAttach ? UCoreShell::GetProperty(this, Property) : "";
}

void UManageBillboardComponent::SetProperty(const FString& Property, const FString& Value)
{
...
void UManageBillboardComponent::PostDuplicate(bool bDuplicateForPIE)
{
...
void UManageBillboardComponent::SetAllPhysicsAngularVelocity(const FVector& NewAngVel, bool bAddToCurrent)
{
...
void UManageBillboardComponent::AddToCluster(UObjectBaseUtility* ClusterRootOrObjectFromCluster, bool bAddAsMutableObject)
{
