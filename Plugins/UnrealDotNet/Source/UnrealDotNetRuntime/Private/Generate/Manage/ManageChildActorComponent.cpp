...
FString UManageChildActorComponent::GetProperty(const FString& Property)
{
	return bIsManageAttach ? UCoreShell::GetProperty(this, Property) : "";
}

void UManageChildActorComponent::SetProperty(const FString& Property, const FString& Value)
{
	if (bIsManageAttach) UCoreShell::SetProperty(this, Property, Value);
}

void UManageChildActorComponent::BeginDestroy()
{
	Super::BeginDestroy();
	if(bIsManageAttach) UCoreShell::InvokeInObject(this, "BeginDestroy");
}

void UManageChildActorComponent::BeginPlay()
{
...
void UManageChildActorComponent::DetachFromParent(bool bMaintainWorldPosition, bool bCallModify)
{
...
void UManageChildActorComponent::CreateCluster()
{
	Super::CreateCluster();
	if(bIsManageAttach) UCoreShell::InvokeInObject(this, "CreateCluster");
}

void UManageChildActorComponent::OnClusterMarkedAsPendingKill()
{
