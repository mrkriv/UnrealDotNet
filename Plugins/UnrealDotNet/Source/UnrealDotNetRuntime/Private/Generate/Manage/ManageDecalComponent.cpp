...
FString UManageDecalComponent::GetProperty(const FString& Property)
{
	return bIsManageAttach ? UCoreShell::GetProperty(this, Property) : "";
}

void UManageDecalComponent::SetProperty(const FString& Property, const FString& Value)
{
...
void UManageDecalComponent::ApplyWorldOffset(const FVector& InOffset, bool bWorldShift)
{
...
void UManageDecalComponent::DetachFromComponent(const FDetachmentTransformRules& DetachmentRules)
{
...
void UManageDecalComponent::OnChildAttached(USceneComponent* ChildComponent)
{
	Super::OnChildAttached(ChildComponent);
	if(bIsManageAttach) UCoreShell::InvokeInObject(this, "OnChildAttached", ChildComponent);
}

void UManageDecalComponent::OnChildDetached(USceneComponent* ChildComponent)
{
...
void UManageDecalComponent::OnUpdateTransform(EUpdateTransformFlags UpdateTransformFlags, ETeleportType Teleport)
{
...
void UManageDecalComponent::SetRelativeScale3D(FVector NewScale3D)
{
...
void UManageDecalComponent::AddTickPrerequisiteActor(AActor* PrerequisiteActor)
{
	Super::AddTickPrerequisiteActor(PrerequisiteActor);
	if(bIsManageAttach) UCoreShell::InvokeInObject(this, "AddTickPrerequisiteActor", PrerequisiteActor);
}

void UManageDecalComponent::AddTickPrerequisiteComponent(UActorComponent* PrerequisiteComponent)
{
...
void UManageDecalComponent::PostRename(UObject* OldOuter, const FName OldName)
{
...
void UManageDecalComponent::RemoveTickPrerequisiteActor(AActor* PrerequisiteActor)
{
	Super::RemoveTickPrerequisiteActor(PrerequisiteActor);
	if(bIsManageAttach) UCoreShell::InvokeInObject(this, "RemoveTickPrerequisiteActor", PrerequisiteActor);
}

void UManageDecalComponent::RemoveTickPrerequisiteComponent(UActorComponent* PrerequisiteComponent)
{
...
void UManageDecalComponent::AddToCluster(UObjectBaseUtility* ClusterRootOrObjectFromCluster, bool bAddAsMutableObject)
{
