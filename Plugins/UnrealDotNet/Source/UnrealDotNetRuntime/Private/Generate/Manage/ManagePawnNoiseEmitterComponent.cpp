...
FString UManagePawnNoiseEmitterComponent::GetProperty(const FString& Property)
{
	return bIsManageAttach ? UCoreShell::GetProperty(this, Property) : "";
}

void UManagePawnNoiseEmitterComponent::SetProperty(const FString& Property, const FString& Value)
{
...
void UManagePawnNoiseEmitterComponent::UpdateComponentToWorld(EUpdateTransformFlags UpdateTransformFlags, ETeleportType Teleport)
{
...
void UManagePawnNoiseEmitterComponent::AddToCluster(UObjectBaseUtility* ClusterRootOrObjectFromCluster, bool bAddAsMutableObject)
{
