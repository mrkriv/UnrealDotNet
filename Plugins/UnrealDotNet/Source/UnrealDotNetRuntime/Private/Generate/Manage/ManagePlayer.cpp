...
FString UManagePlayer::GetProperty(const FString& Property)
{
	return bIsManageAttach ? UCoreShell::GetProperty(this, Property) : "";
}

void UManagePlayer::SetProperty(const FString& Property, const FString& Value)
{
...
void UManagePlayer::AddToCluster(UObjectBaseUtility* ClusterRootOrObjectFromCluster, bool bAddAsMutableObject)
{
