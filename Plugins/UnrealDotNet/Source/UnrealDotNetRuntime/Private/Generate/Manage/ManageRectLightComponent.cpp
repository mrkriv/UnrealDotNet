...
void UManageRectLightComponent::DetachFromComponent(const FDetachmentTransformRules& DetachmentRules)
{
...
void UManageRectLightComponent::OnChildAttached(USceneComponent* ChildComponent)
{
...
void UManageRectLightComponent::OnChildDetached(USceneComponent* ChildComponent)
{
...
void UManageRectLightComponent::OnUpdateTransform(EUpdateTransformFlags UpdateTransformFlags, ETeleportType Teleport)
{
...
void UManageRectLightComponent::SetRelativeScale3D(FVector NewScale3D)
{
...
void UManageRectLightComponent::AddTickPrerequisiteActor(AActor* PrerequisiteActor)
{
...
void UManageRectLightComponent::AddTickPrerequisiteComponent(UActorComponent* PrerequisiteComponent)
{
...
void UManageRectLightComponent::ApplyWorldOffset(const FVector& InOffset, bool bWorldShift)
{
...
void UManageRectLightComponent::RemoveTickPrerequisiteActor(AActor* PrerequisiteActor)
{
...
void UManageRectLightComponent::RemoveTickPrerequisiteComponent(UActorComponent* PrerequisiteComponent)
{
...
void UManageRectLightComponent::OverridePerObjectConfigSection(FString& SectionName)
{
...
void UManageRectLightComponent::PostRename(UObject* OldOuter, const FName OldName)
{
