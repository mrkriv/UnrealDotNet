...
FString UManageSceneCaptureComponent2D::GetProperty(const FString& Property)
{
	return bIsManageAttach ? UCoreShell::GetProperty(this, Property) : "";
}

void UManageSceneCaptureComponent2D::SetProperty(const FString& Property, const FString& Value)
{
...
void UManageSceneCaptureComponent2D::ApplyWorldOffset(const FVector& InOffset, bool bWorldShift)
{
...
void UManageSceneCaptureComponent2D::DetachFromComponent(const FDetachmentTransformRules& DetachmentRules)
{
...
void UManageSceneCaptureComponent2D::OnChildAttached(USceneComponent* ChildComponent)
{
	Super::OnChildAttached(ChildComponent);
	if(bIsManageAttach) UCoreShell::InvokeInObject(this, "OnChildAttached", ChildComponent);
}

void UManageSceneCaptureComponent2D::OnChildDetached(USceneComponent* ChildComponent)
{
...
void UManageSceneCaptureComponent2D::OnUpdateTransform(EUpdateTransformFlags UpdateTransformFlags, ETeleportType Teleport)
{
...
void UManageSceneCaptureComponent2D::SetRelativeScale3D(FVector NewScale3D)
{
...
void UManageSceneCaptureComponent2D::AddTickPrerequisiteActor(AActor* PrerequisiteActor)
{
	Super::AddTickPrerequisiteActor(PrerequisiteActor);
	if(bIsManageAttach) UCoreShell::InvokeInObject(this, "AddTickPrerequisiteActor", PrerequisiteActor);
}

void UManageSceneCaptureComponent2D::AddTickPrerequisiteComponent(UActorComponent* PrerequisiteComponent)
{
...
void UManageSceneCaptureComponent2D::PostRename(UObject* OldOuter, const FName OldName)
{
...
void UManageSceneCaptureComponent2D::RemoveTickPrerequisiteActor(AActor* PrerequisiteActor)
{
	Super::RemoveTickPrerequisiteActor(PrerequisiteActor);
	if(bIsManageAttach) UCoreShell::InvokeInObject(this, "RemoveTickPrerequisiteActor", PrerequisiteActor);
}

void UManageSceneCaptureComponent2D::RemoveTickPrerequisiteComponent(UActorComponent* PrerequisiteComponent)
{
...
void UManageSceneCaptureComponent2D::AddToCluster(UObjectBaseUtility* ClusterRootOrObjectFromCluster, bool bAddAsMutableObject)
{
