...
FString UManageSkyLightComponent::GetProperty(const FString& Property)
{
	return bIsManageAttach ? UCoreShell::GetProperty(this, Property) : "";
}

void UManageSkyLightComponent::SetProperty(const FString& Property, const FString& Value)
{
...
void UManageSkyLightComponent::AddToCluster(UObjectBaseUtility* ClusterRootOrObjectFromCluster, bool bAddAsMutableObject)
{
