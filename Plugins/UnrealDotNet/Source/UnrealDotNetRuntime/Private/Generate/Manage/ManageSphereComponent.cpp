...
FString UManageSphereComponent::GetProperty(const FString& Property)
{
	return bIsManageAttach ? UCoreShell::GetProperty(this, Property) : "";
}

void UManageSphereComponent::SetProperty(const FString& Property, const FString& Value)
{
...
void UManageSphereComponent::PostDuplicate(bool bDuplicateForPIE)
{
...
void UManageSphereComponent::SetAllPhysicsAngularVelocity(const FVector& NewAngVel, bool bAddToCurrent)
{
...
void UManageSphereComponent::AddToCluster(UObjectBaseUtility* ClusterRootOrObjectFromCluster, bool bAddAsMutableObject)
{
