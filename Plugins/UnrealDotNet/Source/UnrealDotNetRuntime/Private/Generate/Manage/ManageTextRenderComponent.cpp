...
void UManageTextRenderComponent::AddTorqueInRadians(FVector Torque, FName BoneName, bool bAccelChange)
{
...
void UManageTextRenderComponent::ReceiveComponentDamage(float DamageAmount, const FDamageEvent& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
...
void UManageTextRenderComponent::SetAllPhysicsRotation(FRotator NewRot)
{
...
void UManageTextRenderComponent::SetPhysicsAngularVelocityInRadians(FVector NewAngVel, bool bAddToCurrent, FName BoneName)
{
...
void UManageTextRenderComponent::SetPhysicsLinearVelocity(FVector NewVel, bool bAddToCurrent, FName BoneName)
{
...
void UManageTextRenderComponent::OverridePerObjectConfigSection(FString& SectionName)
{
