...
#include "ManageAIDataProvider_QueryParams.generated.h"
...
UCLASS()
class UNREALDOTNETRUNTIME_API UManageAIDataProvider_QueryParams : public UAIDataProvider_QueryParams, public IManageObject
{
	GENERATED_BODY()
