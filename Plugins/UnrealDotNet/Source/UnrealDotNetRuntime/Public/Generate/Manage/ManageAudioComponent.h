...
public:
	...
	void _Supper__FadeIn(float FadeInDuration, float FadeVolumeLevel, float StartTime);
	void _Supper__FadeOut(float FadeOutDuration, float FadeVolumeLevel);
	void _Supper__Play(float StartTime);
	void _Supper__Stop();
