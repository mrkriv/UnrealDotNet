...
#include "ManageCameraComponent.generated.h"

// Source file C:\Program Files\Epic Games\UE_4.22\Engine\Source\Runtime\Engine\Classes\Camera\CameraComponent.h:21

UCLASS()
class UNREALDOTNETRUNTIME_API UManageCameraComponent : public UCameraComponent, public IManageObject
{
	GENERATED_BODY()
...
public:
	...
	void _Supper__NotifyCameraCut();
	void _Supper__SetFieldOfView(float InFieldOfView);
