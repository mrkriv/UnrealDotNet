...
public:
	...
	void _Supper__AbortMatch();
	void _Supper__EndMatch();
	void _Supper__HandleLeavingMap();
	void _Supper__HandleMatchAborted();
	void _Supper__HandleMatchHasEnded();
	void _Supper__HandleMatchHasStarted();
	void _Supper__HandleMatchIsWaitingToStart();
	void _Supper__MatineeCancelled();
	void _Supper__OnMatchStateSet();
	void _Supper__PostCommitMapChange();
	void _Supper__RestartGame();
	void _Supper__SetBandwidthLimit(float AsyncIOBandwidthLimit);
	void _Supper__StartMatch();
	void _Supper__InitGameState();
	void _Supper__PostSeamlessTravel();
	void _Supper__ResetLevel();
	void _Supper__ReturnToMainMenuHost();
	void _Supper__StartPlay();
	void _Supper__StartToLeaveMap();
