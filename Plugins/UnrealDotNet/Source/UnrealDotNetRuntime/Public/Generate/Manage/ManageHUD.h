...
public:
	...
	void _Supper__DrawHUD();
	void _Supper__DrawSafeZoneOverlay();
	void _Supper__HandleBugScreenShot();
	void _Supper__NextDebugTarget();
	void _Supper__NotifyBindPostProcessEffects();
	void _Supper__OnLostFocusPause(bool bEnable);
	void _Supper__PostRender();
	void _Supper__PreviousDebugTarget();
	void _Supper__ShowDebugInfo(float& YL, float& YPos);
	void _Supper__ShowHUD();
