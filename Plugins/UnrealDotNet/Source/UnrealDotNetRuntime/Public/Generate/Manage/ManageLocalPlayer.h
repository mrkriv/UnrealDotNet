...
#include "ManageLocalPlayer.generated.h"

// Source file C:\Program Files\Epic Games\UE_4.22\Engine\Source\Runtime\Engine\Classes\Engine\LocalPlayer.h:163

UCLASS()
class UNREALDOTNETRUNTIME_API UManageLocalPlayer : public ULocalPlayer, public IManageObject
{
	GENERATED_BODY()
...
public:
	...
	virtual void SendSplitJoin() override;
	...
	void _Supper__InitOnlineSession();
	void _Supper__PlayerRemoved();
	void _Supper__SendSplitJoin();
	void _Supper__SetControllerId(int32 NewControllerId);
