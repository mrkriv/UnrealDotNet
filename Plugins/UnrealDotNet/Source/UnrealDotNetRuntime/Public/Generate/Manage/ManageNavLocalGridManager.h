...
#include "ManageNavLocalGridManager.generated.h"
...
UCLASS()
class UNREALDOTNETRUNTIME_API UManageNavLocalGridManager : public UNavLocalGridManager, public IManageObject
{
	GENERATED_BODY()
