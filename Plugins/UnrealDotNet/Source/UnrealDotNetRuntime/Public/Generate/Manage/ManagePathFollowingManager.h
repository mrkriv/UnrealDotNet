...
#include "ManagePathFollowingManager.generated.h"
...
UCLASS()
class UNREALDOTNETRUNTIME_API UManagePathFollowingManager : public UPathFollowingManager, public IManageObject
{
	GENERATED_BODY()
